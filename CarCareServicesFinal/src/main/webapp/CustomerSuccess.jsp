...
<a href ="/CarCareServicesFinal/SelectService.html">Request Servicing</a>
<a href="/CarCareServicesFinal/CustomerChangePassword.html">Change password</a>
<a href="/CarCareServicesFinal/CustomerLogout">Logout</a>
...
%>
		...
		try{
			...
			String s ="SELECT * FROM booking where username = ?";
